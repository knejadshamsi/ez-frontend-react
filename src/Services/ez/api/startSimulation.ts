...
export const startSimulation = async (setState: (state: EZServiceState) => void): Promise<void> => {
...
const runDemoSimulation = (setState: (state: EZServiceState) => void): (() => void) => {
...
const runRealSimulation = (setState: (state: EZServiceState) => void): void => {
